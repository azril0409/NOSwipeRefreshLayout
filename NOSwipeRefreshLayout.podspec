#
#  Be sure to run `pod spec lint NOSwipeRefreshLayout.podspec' to ensure this is a
...
limitations under the License.
  ...
  spec.author             = { "Deo0409" => "azril0409@gmail.com" }
  # Or just: spec.author    = "Deo"
  # spec.authors            = { "Deo" => "deo@chainmeans.com" }
  # spec.social_media_url   = "https://twitter.com/Deo"
  ...
  spec.source       = { :git => "https://github.com/azril0409/NOSwipeRefreshLayout.git", :tag => "#{spec.version}" }
